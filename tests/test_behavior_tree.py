...
def test_bt_build_simple(inorbit_api):
    ...
    """
    worker_pool = WorkerPool(db=DummyDB(), api=inorbit_api)
    ...
    tree: BehaviorTree = worker_pool.build_tree_for_mission(context)
        ...
        "children": [
            {
                ...
                "label": "mission mission123",
                "children": [
                    {"type": "MissionStartNode", "state": "", "label": "mission start"},
